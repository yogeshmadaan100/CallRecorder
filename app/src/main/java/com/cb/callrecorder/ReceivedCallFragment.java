 ...
 */
public class ReceivedCallFragment extends Fragment implements SpeedDialAdapter.AdapterInterface {
    ...
    public static ReceivedCallFragment newInstance() {
        return new ReceivedCallFragment();
    }

    public ReceivedCallFragment() {
